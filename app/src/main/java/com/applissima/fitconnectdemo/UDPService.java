...
public class UDPService extends Service {
    ...
    private final String clsName = "UDPService";
    private boolean bKeepRunning = true;
    private String SERVERIP;
    private final int SERVERPORT = 1199;
    ...
    *//*public UDPService(){
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //Toast.makeText(this, "UDPService bounded to DBService", Toast.LENGTH_LONG).show();
        Log.i("UDPService", "UDPService bounded to DBService");

        init();

        //Toast.makeText(this, "UDPService Started", Toast.LENGTH_LONG).show();
        Log.i("UDPService", "UDPService Started");


        mHandler = new Handler();

        mHandler.postDelayed(runRefreshWaitingList, Settings.checkUnknownProfile * 60 * 1000);
        mHandler.postDelayed(runGenDataSimUsers, 1000);
        mHandler.postDelayed(runMinute, 60 * 1000);

        return START_NOT_STICKY;
    }

    // *******  UDPService RUNNABLES   ********* //
    ...
    public void onDestroy() {
        ...
        Log.i("UDPService", "UDPService Destroyed");
        //Toast.makeText(this, "UDPService Destroyed", Toast.LENGTH_SHORT).show();
    }
    ...
    *//*public void setTimerForUdpBgThread(){
    ...
    *//*private void addDataToMinAgg(final Map<String, List<RawData>> curDataMap, final List<String> curUDPList){
    ...
    private RawData byteToRawData(byte[] data){
...
*//*
    ...
    *//*public RawData generateRandomRawData(){
    ...
    private void generateRandomDataForSimUsers(){
    ...
    private RawData generateRandomRawData(String deviceNo){
    ...
    *//*public void interruptUDPThreads(){
        if(udpBgThread!=null) {
